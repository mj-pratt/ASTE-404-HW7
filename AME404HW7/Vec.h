...
#include <ostream>
#include <math.h>
/*! The class used to define 3D vector objects
@param a maxtrix component i
@param a maxtrix component j
@param a maxtrix component k
...
public:
    ...
    /*! Returns magnitude \f$ \sqrt{\^{i}^2 + \^{j}^2 + \^{k}^2} \f$
    @param a vector
